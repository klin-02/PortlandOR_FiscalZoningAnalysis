...
def GeoRDDAnalysis(highways_gdf, redlining_gdf, lots_gdf, zoning_gdf):
    import Services.DiscontService as ds
    ...
    #actual
    ds.FitRDD(lots_gdf, x_label="distance to border (mi)", y_label="total value/acre")

    #covars
    ds.FitRDD(lots_gdf, x_label="distance to border (mi)", y_label="YEARBUILT")

    #placebos
    ds.FitRDD(lots_gdf, x_label="distance to border (mi)", y_label="distance to redlined border (mi)")
    ds.FitRDD(lots_gdf, x_label="distance to border (mi)", y_label="distance to highway (mi)")
